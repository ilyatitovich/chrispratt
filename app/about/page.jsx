        ...
        <>
            ...
            <main className="main">
                ...
                >
                        ...
                        <div className="container medium once-in">
                            <div className="row">
                                <div className="flex-col">
                                    <h1>
                                        <span>Capturing moment</span>
                                        <span>that make life shine</span>
                                    </h1>
                                </div>
                            </div>
                        </div>
                    ...
                    <ScrollSection
                        animate={{ backgroundColor: "#E9EAEB" }}
                        start={"center 80%"}
                        end={"bottom bottom"}
                    >
                        <section className="section about-image once-in">
                            ...
                            <div className="container">
                                <div className="row">
                                    <div className="flex-col">
                                        <div className="about-arrow arrow">
                                            <ScrollSection
                                                animate={{ rotate: 30 }}
                                                start={"top center"}
                                                end={"+=100"}
                        ...
                        <div className="container">
                            ...
                            <div className="row">
                                <div className="flex-col">
                                    ...
                                    <p>
                                        Event photography encompasses various
                                        occasions such as weddings, corporate
                                        events, parties, and more. Photographers
                                        capture the essence of these events,
                                        creating lasting memories through candid
                                        and posed shots.
                                    </p>
                                </div>
                                <div className="flex-col">
                                    ...
                                    <p>
                                        Portrait photography involves capturing
                                        individuals or groups in a studio or
                                        outdoor setting. Photographers use their
                                        expertise to bring out the best in their
                                        subjects, creating stunning,
                                        personality-rich portraits.
                                    </p>
                                </div>
                                <div className="flex-col">
                                    <h5>03</h5>
                                    ...
                                    <p>
                                        Product photographers specialize in
                                        showcasing products for businesses. They
                                        create high-quality images that
                                        highlight the features, details, and
                                        aesthetics of products, making them more
                            ...
                            <div className="row">
                                <div className="flex-col">
                                    <div className="single-image">
                                        ...
                                        >
                                            <div className="overlay is-inview">
                                                <Image
                                                    src="/portrait-img-1.jpg"
                                                    fill={true}
                                                    alt="img-2"
                                                    style={{
                                                        objectFit: "cover",
                                ...
                                <div className="flex-col">
                                    ...
                                    >
                                        <div className="awwwards-badge">
                                            ...
                                            >
                                                <path
                                                    d="m37.068.118-4.8 26.632-5.577.734-6.588-15.95-2.236 17.112-5.577.734L.76 4.898l6.34-.835 6.873 16.944 2-18.112 5.883-.774 6.62 16.977L30.729.952l6.339-.834zm11.367 20.48c.32 2.434-1.264 4.499-3.698 4.82-2.434.32-4.5-1.265-4.821-3.699-.32-2.434 1.265-4.5 3.699-4.82 2.434-.32 4.5 1.265 4.82 3.699z"
                                                    fill="#999D9E"
                                                    fillRule="evenodd"
                                                />
                                            </svg>
                                    ...
                                    <p>
                                        ...
                                        jury member for the icon Awards. Being
                                        part of this esteemed panel has been an
                                        extraordinary experience, allowing me to
                                        witness the exceptional talent and
                                        creativity within the photography
                                        community.
                                    </p>
                                </div>
                            </div>
